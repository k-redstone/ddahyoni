  ...
  },
  {
    ...
    sets: [
      ...
      },
      {
        ...
        setNumber: 2,
        winner: '노코멘트',
        blueTeamBans: ['Ambessa', 'Ezreal', 'Yuumi', 'Xayah', 'Varus'],
        redTeamBans: ['Hwei', 'Vi', 'Zyra', 'Blitzcrank', 'Rakan'],
        blueTeamPicks: ['Viktor', 'Viego', 'Sion', 'Jhin', 'Leona'],
        redTeamPicks: ['Lillia', 'Ahri', 'Sett', 'Jinx', 'Maokai'],
        blueTeamKills: 7,
        redTeamKills: 25,
        blueTeamDeath: 25,
        redTeamDeath: 7,
